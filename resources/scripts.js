window.imm = {
    ...
    drawArrows(nodeId) {
        ...
        for (let i = 0; i < nodes.length; i++) {
            ...
            arrow.setAttribute('style', 'transform: rotate(' + degrees + 'deg);left:'+originRight+'px;top:'+originTop+'px;height: '+deltaHyp+'px; transform-origin: '+originRight+'px '+originTop+'px;');
        }
