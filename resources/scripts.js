window.imm = {
    ...
    drawArrows(nodeId) {
        ...
        for (let i = 0; i < nodes.length; i++) {
            ...
            arrow.setAttribute('style', 'transform: rotate(' + degrees + 'deg);height: '+deltaHyp+'px;left: '+(originRight+100)+'px;top: '+Math.max(originTop, originTop)+'px;transform-origin: '+originRight+'px '+originTop+'px;');
        }
    },
